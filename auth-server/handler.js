...
const credentials = {
  ...
  redirect_uris: ["https://theo-githu.github.io/meet/"],
  javascript_origins: ["https://theo-githu.github.io", "http://localhost:3000"],
};
  ...
  // The values used to instantiate the OAuthClient are at the top of the file
    ...
    .then((token) => {
      ...
      return {
        statusCode: 200,
        headers: {
          "Access-Control-Allow-Origin": "http://192.168.0.15:8080",
          "Access-Control-Allow-Credentials": true,
        },
